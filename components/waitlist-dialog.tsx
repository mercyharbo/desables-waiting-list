...
export default function WaitlistDialog({
  ...
  const [successData, setSuccessData] = useState<{ uid: string } | null>(null)
        ...
        {showSuccessDialog ? (
          <>
            <DialogHeader className='flex flex-col justify-center items-center gap-3'>
              ...
              <DialogDescription className='dark:text-gray-300 text-gray-600 text-center'>
                Great! You've been successfully added to our waitlist. We'll
                keep you updated and notify you as soon as early access becomes
            ...
            <DialogFooter>
              <Button
                ...
                className='dark:text-black text-white px-5 h-12 mx-auto rounded-3xl w-full '
              >
                Close
              </Button>
            </DialogFooter>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className='dark:text-gray-300 text-gray-600'>
                Enter your details and we'll let you know when early access
                opens.
              </DialogDescription>
            </DialogHeader>
